...
def _get_version(dist: str = "griffe-public-wildcard-imports") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["griffe-public-wildcard-imports"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("GRIFFE_PUBLIC_WILDCARD_IMPORTS")]]
    return _Environment(
